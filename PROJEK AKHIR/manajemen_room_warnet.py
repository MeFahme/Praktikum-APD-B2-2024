...
# Fore adalah salah satu bagian dari colorama untuk mengubah warna teks yang ditampilkan di terminal
...
def booking_room():
    ...
    if nomor_room in rooms_kosong:
        ...
        try:
            ...
            if waktu_booking <= 0:
                raise ValueError("Waktu Booking tidak bisa negatif atau 0")
    ...
    while True:
        ...
        if pilihan == "1":
            ...
            try:
                ...
                if pilih_fasilitas in range(1, len(fasilitas_sekarang) + 1):
